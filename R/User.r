...
User <- R6::R6Class(
  ...
  public = list(
	...
	if(is.null(self$`avatar_url_without_sizing`)) 'NULL' else self$`avatar_url_without_sizing`,
	...
	if(is.null(self$`embed_group_space_id`)) 'NULL' else as.character(self$`embed_group_space_id`),
	if(is.null(self$`first_name`)) 'NULL' else self$`first_name`,
        lapply(self$`group_ids`, function(x) paste(paste0('"', x, '"'), sep=",")),
	if(is.null(self$`home_folder_id`)) 'NULL' else self$`home_folder_id`,
	...
	if(is.null(self$`locale`)) 'NULL' else self$`locale`,
        lapply(self$`looker_versions`, function(x) paste(paste0('"', x, '"'), sep=",")),
	if(is.null(self$`models_dir_validated`)) 'NULL' else self$`models_dir_validated`,
	if(is.null(self$`personal_folder_id`)) 'NULL' else as.character(self$`personal_folder_id`),
	if(is.null(self$`presumed_looker_employee`)) 'NULL' else self$`presumed_looker_employee`,
        lapply(self$`role_ids`, function(x) paste(paste0('"', x, '"'), sep=",")),
        lapply(self$`sessions`, function(x) paste(x$toJSON(), sep=",")),
	if(is.null(self$`ui_state`)) 'NULL' else self$`ui_state`,
	if(is.null(self$`verified_looker_employee`)) 'NULL' else self$`verified_looker_employee`,
	if(is.null(self$`roles_externally_managed`)) 'NULL' else self$`roles_externally_managed`,
