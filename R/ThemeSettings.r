...
ThemeSettings <- R6::R6Class(
  ...
  public = list(
	...
	if(is.null(self$`base_font_size`)) 'NULL' else self$`base_font_size`,
	if(is.null(self$`color_collection_id`)) 'NULL' else self$`color_collection_id`,
	if(is.null(self$`font_color`)) 'NULL' else self$`font_color`,
	if(is.null(self$`font_family`)) 'NULL' else self$`font_family`,
	if(is.null(self$`font_source`)) 'NULL' else self$`font_source`,
	if(is.null(self$`info_button_color`)) 'NULL' else self$`info_button_color`,
	if(is.null(self$`primary_button_color`)) 'NULL' else self$`primary_button_color`,
	...
	if(is.null(self$`warn_button_color`)) 'NULL' else self$`warn_button_color`,
