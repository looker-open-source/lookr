...
GroupIdForGroupInclusion <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(GroupIdForGroupInclusionJsonObject) {
      GroupIdForGroupInclusionObject <- GroupIdForGroupInclusionJsonObject #jsonlite::fromJSON(GroupIdForGroupInclusionJson, simplifyVector = FALSE)
    ...
    fromJSON = function(GroupIdForGroupInclusionJson) {
      GroupIdForGroupInclusionObject <- jsonlite::fromJSON(GroupIdForGroupInclusionJson, simplifyVector = FALSE)
      self$fromJSONObject(GroupIdForGroupInclusionObject)
    },
