...
ApiSession <- R6::R6Class(
  ...
  public = list(
    ...
    `workspace_id` = NULL,
    `sudo_user_id` = NULL,
    initialize = function(`can`, `workspace_id`, `sudo_user_id`){
      if (!missing(`can`)) {
        self$`can` <- `can`
      }
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`sudo_user_id`)) {
        ApiSessionObject[['sudo_user_id']] <- self$`sudo_user_id`
      }

      ApiSessionObject
    },
    fromJSONObject = function(ApiSessionJsonObject) {
      ApiSessionObject <- ApiSessionJsonObject #jsonlite::fromJSON(ApiSessionJson, simplifyVector = FALSE)
      ...
      if (!is.null(ApiSessionObject$`sudo_user_id`)) {
        self$`sudo_user_id` <- ApiSessionObject$`sudo_user_id`
      }
    },
    fromJSON = function(ApiSessionJson) {
      ApiSessionObject <- jsonlite::fromJSON(ApiSessionJson, simplifyVector = FALSE)
      self$fromJSONObject(ApiSessionObject)
    },
