...
Space <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(SpaceJsonObject) {
      SpaceObject <- SpaceJsonObject #jsonlite::fromJSON(SpaceJson, simplifyVector = FALSE)
    ...
    fromJSON = function(SpaceJson) {
      SpaceObject <- jsonlite::fromJSON(SpaceJson, simplifyVector = FALSE)
      self$fromJSONObject(SpaceObject)
    },
