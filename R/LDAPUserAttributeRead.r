...
LDAPUserAttributeRead <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(LDAPUserAttributeReadJsonObject) {
      LDAPUserAttributeReadObject <- LDAPUserAttributeReadJsonObject #jsonlite::fromJSON(LDAPUserAttributeReadJson, simplifyVector = FALSE)
    ...
    fromJSON = function(LDAPUserAttributeReadJson) {
      LDAPUserAttributeReadObject <- jsonlite::fromJSON(LDAPUserAttributeReadJson, simplifyVector = FALSE)
      self$fromJSONObject(LDAPUserAttributeReadObject)
    },
