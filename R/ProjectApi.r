...
ProjectApi <- R6::R6Class(
  ...
  public = list(
    ...
    create_git_branch = function(body, project_id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    tag_ref = function(body, project_id, commit_sha, tag_name, tag_message, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    update_git_branch = function(body, project_id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    update_project = function(body, project_id, fields, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    update_repository_credential = function(body, root_project_id, credential_id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
