...
LookmlModelExploreFieldEnumeration <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(LookmlModelExploreFieldEnumerationJsonObject) {
      LookmlModelExploreFieldEnumerationObject <- LookmlModelExploreFieldEnumerationJsonObject #jsonlite::fromJSON(LookmlModelExploreFieldEnumerationJson, simplifyVector = FALSE)
    ...
    fromJSON = function(LookmlModelExploreFieldEnumerationJson) {
      LookmlModelExploreFieldEnumerationObject <- jsonlite::fromJSON(LookmlModelExploreFieldEnumerationJson, simplifyVector = FALSE)
      self$fromJSONObject(LookmlModelExploreFieldEnumerationObject)
    },
