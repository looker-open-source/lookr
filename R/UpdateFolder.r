...
UpdateFolder <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      UpdateFolderObject <- list()
      if (!is.null(self$`name`)) {
        UpdateFolderObject[['name']] <- self$`name`
      }
      if (!is.null(self$`parent_id`)) {
        UpdateFolderObject[['parent_id']] <- self$`parent_id`
      }

      UpdateFolderObject
    },
    fromJSONObject = function(UpdateFolderJsonObject) {
      UpdateFolderObject <- UpdateFolderJsonObject #jsonlite::fromJSON(UpdateFolderJson, simplifyVector = FALSE)
      if (!is.null(UpdateFolderObject$`name`)) {
        self$`name` <- UpdateFolderObject$`name`
      }
      if (!is.null(UpdateFolderObject$`parent_id`)) {
        self$`parent_id` <- UpdateFolderObject$`parent_id`
      }
    },
    fromJSON = function(UpdateFolderJson) {
      UpdateFolderObject <- jsonlite::fromJSON(UpdateFolderJson, simplifyVector = FALSE)
      self$fromJSONObject(UpdateFolderObject)
    },
    ...
    fromJSONString = function(UpdateFolderJson) {
      UpdateFolderObject <- jsonlite::fromJSON(UpdateFolderJson, simplifyVector = FALSE)
      self$`name` <- UpdateFolderObject$`name`
      self$`parent_id` <- UpdateFolderObject$`parent_id`
    }
