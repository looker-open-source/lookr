...
LookApi <- R6::R6Class(
  ...
  public = list(
    ...
    search_looks = function(id, title, description, content_favorite_id, space_id, user_id, view_count, deleted, query_id, curate, fields, page, per_page, limit, offset, sorts, filter_or, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    update_look = function(body, look_id, fields, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
