...
UpdateSpace <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      UpdateSpaceObject <- list()
      if (!is.null(self$`name`)) {
        UpdateSpaceObject[['name']] <- self$`name`
      }
      if (!is.null(self$`parent_id`)) {
        UpdateSpaceObject[['parent_id']] <- self$`parent_id`
      }

      UpdateSpaceObject
    },
    fromJSONObject = function(UpdateSpaceJsonObject) {
      UpdateSpaceObject <- UpdateSpaceJsonObject #jsonlite::fromJSON(UpdateSpaceJson, simplifyVector = FALSE)
      if (!is.null(UpdateSpaceObject$`name`)) {
        self$`name` <- UpdateSpaceObject$`name`
      }
      if (!is.null(UpdateSpaceObject$`parent_id`)) {
        self$`parent_id` <- UpdateSpaceObject$`parent_id`
      }
    },
    fromJSON = function(UpdateSpaceJson) {
      UpdateSpaceObject <- jsonlite::fromJSON(UpdateSpaceJson, simplifyVector = FALSE)
      self$fromJSONObject(UpdateSpaceObject)
    },
    ...
    fromJSONString = function(UpdateSpaceJson) {
      UpdateSpaceObject <- jsonlite::fromJSON(UpdateSpaceJson, simplifyVector = FALSE)
      self$`name` <- UpdateSpaceObject$`name`
      self$`parent_id` <- UpdateSpaceObject$`parent_id`
    }
