...
LookModel <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(LookModelJsonObject) {
      LookModelObject <- LookModelJsonObject #jsonlite::fromJSON(LookModelJson, simplifyVector = FALSE)
    ...
    fromJSON = function(LookModelJson) {
      LookModelObject <- jsonlite::fromJSON(LookModelJson, simplifyVector = FALSE)
      self$fromJSONObject(LookModelObject)
    },
