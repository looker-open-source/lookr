...
Permission <- R6::R6Class(
  ...
  public = list(
    ...
    `parent` = NULL,
    `description` = NULL,
    initialize = function(`can`, `permission`, `parent`, `description`){
      if (!missing(`can`)) {
        self$`can` <- `can`
      }
    ...
    fromJSONObject = function(PermissionJsonObject) {
      PermissionObject <- PermissionJsonObject #jsonlite::fromJSON(PermissionJson, simplifyVector = FALSE)
    ...
    fromJSON = function(PermissionJson) {
      PermissionObject <- jsonlite::fromJSON(PermissionJson, simplifyVector = FALSE)
      self$fromJSONObject(PermissionObject)
    },
