  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`vis_config`)) {
        SqlQueryCreateObject[['vis_config']] <- self$`vis_config`$toJSON()
      }
    ...
    fromJSONObject = function(SqlQueryCreateJsonObject) {
      ...
      if (!is.null(SqlQueryCreateObject$`vis_config`)) {
        ...
        vis_configObject$fromJSON(jsonlite::toJSON(SqlQueryCreateObject$vis_config, auto_unbox = TRUE))
    ...
    fromJSONString = function(SqlQueryCreateJson) {
      ...
      self$`vis_config` <- TODO_OBJECT_MAPPINGObject$fromJSON(jsonlite::toJSON(SqlQueryCreateObject$vis_config, auto_unbox = TRUE))
    }
  )
)
