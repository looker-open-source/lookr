...
#' @export
InternalHelpResources <- R6::R6Class(
  'InternalHelpResources',
  public = list(
    `can` = NULL,
    `enabled` = NULL,
    initialize = function(`can`, `enabled`){
      if (!missing(`can`)) {
        self$`can` <- `can`
      }
      if (!missing(`enabled`)) {
    ...
    toJSON = function() {
      InternalHelpResourcesObject <- list()
      if (!is.null(self$`can`)) {
        InternalHelpResourcesObject[['can']] <- self$`can`
      }
      if (!is.null(self$`enabled`)) {
        InternalHelpResourcesObject[['enabled']] <- self$`enabled`
      }

      InternalHelpResourcesObject
    },
    fromJSONObject = function(InternalHelpResourcesJsonObject) {
      InternalHelpResourcesObject <- InternalHelpResourcesJsonObject #jsonlite::fromJSON(InternalHelpResourcesJson, simplifyVector = FALSE)
      if (!is.null(InternalHelpResourcesObject$`can`)) {
        self$`can` <- InternalHelpResourcesObject$`can`
      }
      if (!is.null(InternalHelpResourcesObject$`enabled`)) {
        self$`enabled` <- InternalHelpResourcesObject$`enabled`
      }
    },
    fromJSON = function(InternalHelpResourcesJson) {
      InternalHelpResourcesObject <- jsonlite::fromJSON(InternalHelpResourcesJson, simplifyVector = FALSE)
      self$fromJSONObject(InternalHelpResourcesObject)
    },
