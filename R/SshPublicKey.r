...
SshPublicKey <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      SshPublicKeyObject <- list()
      if (!is.null(self$`public_key`)) {
        SshPublicKeyObject[['public_key']] <- self$`public_key`
      }

      SshPublicKeyObject
    },
    fromJSONObject = function(SshPublicKeyJsonObject) {
      SshPublicKeyObject <- SshPublicKeyJsonObject #jsonlite::fromJSON(SshPublicKeyJson, simplifyVector = FALSE)
      if (!is.null(SshPublicKeyObject$`public_key`)) {
        self$`public_key` <- SshPublicKeyObject$`public_key`
      }
    },
    fromJSON = function(SshPublicKeyJson) {
      SshPublicKeyObject <- jsonlite::fromJSON(SshPublicKeyJson, simplifyVector = FALSE)
      self$fromJSONObject(SshPublicKeyObject)
    },
