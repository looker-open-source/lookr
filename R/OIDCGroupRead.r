...
OIDCGroupRead <- R6::R6Class(
  ...
  public = list(
    ...
    `name` = NULL,
    `roles` = NULL,
    initialize = function(`id`, `looker_group_id`, `looker_group_name`, `name`, `roles`){
      if (!missing(`id`)) {
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`id`)) {
        OIDCGroupReadObject[['id']] <- self$`id`
      }
      if (!is.null(self$`looker_group_id`)) {
        OIDCGroupReadObject[['looker_group_id']] <- self$`looker_group_id`
      }
      if (!is.null(self$`looker_group_name`)) {
        OIDCGroupReadObject[['looker_group_name']] <- self$`looker_group_name`
      }
    ...
    fromJSONObject = function(OIDCGroupReadJsonObject) {
      OIDCGroupReadObject <- OIDCGroupReadJsonObject #jsonlite::fromJSON(OIDCGroupReadJson, simplifyVector = FALSE)
      if (!is.null(OIDCGroupReadObject$`id`)) {
        self$`id` <- OIDCGroupReadObject$`id`
      }
      if (!is.null(OIDCGroupReadObject$`looker_group_id`)) {
        self$`looker_group_id` <- OIDCGroupReadObject$`looker_group_id`
      }
      if (!is.null(OIDCGroupReadObject$`looker_group_name`)) {
        self$`looker_group_name` <- OIDCGroupReadObject$`looker_group_name`
      }
    ...
    fromJSON = function(OIDCGroupReadJson) {
      OIDCGroupReadObject <- jsonlite::fromJSON(OIDCGroupReadJson, simplifyVector = FALSE)
      self$fromJSONObject(OIDCGroupReadObject)
    },
