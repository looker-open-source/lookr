...
Snippet <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(SnippetJsonObject) {
      SnippetObject <- SnippetJsonObject #jsonlite::fromJSON(SnippetJson, simplifyVector = FALSE)
    ...
    fromJSON = function(SnippetJson) {
      SnippetObject <- jsonlite::fromJSON(SnippetJson, simplifyVector = FALSE)
      self$fromJSONObject(SnippetObject)
    },
