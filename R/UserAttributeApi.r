...
#' @description looker.UserAttribute
#'
...
UserAttributeApi <- R6::R6Class(
  ...
  public = list(
    ...
    set_user_attribute_group_values = function(user_attribute_id, body, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    update_user_attribute = function(user_attribute_id, body, fields, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
