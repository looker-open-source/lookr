...
#' @title UserAttribute operations
#' @description swagger.UserAttribute
#'
...
UserAttributeApi <- R6::R6Class(
  ...
  public = list(
    ...
    all_user_attribute_group_values = function(user_attribute_id, fields, ...){
      args <- list(...)
      queryParams <- list()
      ...
      urlPath <- "/user_attributes/{user_attribute_id}/group_values"
    ...
    all_user_attributes = function(fields, sorts, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    create_user_attribute = function(body, fields, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    delete_user_attribute = function(user_attribute_id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()

      urlPath <- "/user_attributes/{user_attribute_id}"
      if (!missing(`user_attribute_id`)) {
        urlPath <- gsub(paste0("\\{", "user_attribute_id", "\\}"), `user_attribute_id`, urlPath)
      }
    ...
    set_user_attribute_group_values = function(body, user_attribute_id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    update_user_attribute = function(body, user_attribute_id, fields, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    user_attribute = function(user_attribute_id, fields, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
