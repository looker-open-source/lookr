...
GroupIdForGroupUserInclusion <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(GroupIdForGroupUserInclusionJsonObject) {
      GroupIdForGroupUserInclusionObject <- GroupIdForGroupUserInclusionJsonObject #jsonlite::fromJSON(GroupIdForGroupUserInclusionJson, simplifyVector = FALSE)
    ...
    fromJSON = function(GroupIdForGroupUserInclusionJson) {
      GroupIdForGroupUserInclusionObject <- jsonlite::fromJSON(GroupIdForGroupUserInclusionJson, simplifyVector = FALSE)
      self$fromJSONObject(GroupIdForGroupUserInclusionObject)
    },
