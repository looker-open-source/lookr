...
LDAPGroupWrite <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`id`)) {
        LDAPGroupWriteObject[['id']] <- self$`id`
      }
      if (!is.null(self$`looker_group_id`)) {
        LDAPGroupWriteObject[['looker_group_id']] <- self$`looker_group_id`
      }
      if (!is.null(self$`looker_group_name`)) {
        LDAPGroupWriteObject[['looker_group_name']] <- self$`looker_group_name`
      }
    ...
    fromJSONObject = function(LDAPGroupWriteJsonObject) {
      LDAPGroupWriteObject <- LDAPGroupWriteJsonObject #jsonlite::fromJSON(LDAPGroupWriteJson, simplifyVector = FALSE)
      if (!is.null(LDAPGroupWriteObject$`id`)) {
        self$`id` <- LDAPGroupWriteObject$`id`
      }
      if (!is.null(LDAPGroupWriteObject$`looker_group_id`)) {
        self$`looker_group_id` <- LDAPGroupWriteObject$`looker_group_id`
      }
      if (!is.null(LDAPGroupWriteObject$`looker_group_name`)) {
        self$`looker_group_name` <- LDAPGroupWriteObject$`looker_group_name`
      }
    ...
    fromJSON = function(LDAPGroupWriteJson) {
      LDAPGroupWriteObject <- jsonlite::fromJSON(LDAPGroupWriteJson, simplifyVector = FALSE)
      self$fromJSONObject(LDAPGroupWriteObject)
    },
