...
SamlUserAttributeWrite <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(SamlUserAttributeWriteJsonObject) {
      SamlUserAttributeWriteObject <- SamlUserAttributeWriteJsonObject #jsonlite::fromJSON(SamlUserAttributeWriteJson, simplifyVector = FALSE)
    ...
    fromJSON = function(SamlUserAttributeWriteJson) {
      SamlUserAttributeWriteObject <- jsonlite::fromJSON(SamlUserAttributeWriteJson, simplifyVector = FALSE)
      self$fromJSONObject(SamlUserAttributeWriteObject)
    },
