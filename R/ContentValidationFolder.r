...
#' @export
ContentValidationFolder <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ContentValidationFolderObject <- list()
      if (!is.null(self$`name`)) {
        ContentValidationFolderObject[['name']] <- self$`name`
      }
      if (!is.null(self$`id`)) {
        ContentValidationFolderObject[['id']] <- self$`id`
      }

      ContentValidationFolderObject
    },
    fromJSONObject = function(ContentValidationFolderJsonObject) {
      ContentValidationFolderObject <- ContentValidationFolderJsonObject #jsonlite::fromJSON(ContentValidationFolderJson, simplifyVector = FALSE)
      if (!is.null(ContentValidationFolderObject$`name`)) {
        self$`name` <- ContentValidationFolderObject$`name`
      }
      if (!is.null(ContentValidationFolderObject$`id`)) {
        self$`id` <- ContentValidationFolderObject$`id`
      }
    },
    fromJSON = function(ContentValidationFolderJson) {
      ContentValidationFolderObject <- jsonlite::fromJSON(ContentValidationFolderJson, simplifyVector = FALSE)
      self$fromJSONObject(ContentValidationFolderObject)
    },
