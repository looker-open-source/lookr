...
Session <- R6::R6Class(
  ...
  public = list(
	...
	if(is.null(self$`ip_address`)) 'NULL' else self$`ip_address`,
	if(is.null(self$`browser`)) 'NULL' else self$`browser`,
	if(is.null(self$`operating_system`)) 'NULL' else self$`operating_system`,
	if(is.null(self$`city`)) 'NULL' else self$`city`,
	if(is.null(self$`state`)) 'NULL' else self$`state`,
	if(is.null(self$`country`)) 'NULL' else self$`country`,
	if(is.null(self$`credentials_type`)) 'NULL' else self$`credentials_type`,
	if(is.null(self$`extended_at`)) 'NULL' else self$`extended_at`,
	if(is.null(self$`extended_count`)) 'NULL' else as.character(self$`extended_count`),
	...
	if(is.null(self$`expires_at`)) 'NULL' else self$`expires_at`,
