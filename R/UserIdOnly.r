...
UserIdOnly <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(UserIdOnlyJsonObject) {
      UserIdOnlyObject <- UserIdOnlyJsonObject #jsonlite::fromJSON(UserIdOnlyJson, simplifyVector = FALSE)
      if (!is.null(UserIdOnlyObject$`id`)) {
        self$`id` <- UserIdOnlyObject$`id`
      }
    },
    fromJSON = function(UserIdOnlyJson) {
      UserIdOnlyObject <- jsonlite::fromJSON(UserIdOnlyJson, simplifyVector = FALSE)
      self$fromJSONObject(UserIdOnlyObject)
    },
