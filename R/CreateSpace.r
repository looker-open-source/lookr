...
CreateSpace <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      CreateSpaceObject <- list()
      if (!is.null(self$`name`)) {
        CreateSpaceObject[['name']] <- self$`name`
      }
      if (!is.null(self$`parent_id`)) {
        CreateSpaceObject[['parent_id']] <- self$`parent_id`
      }

      CreateSpaceObject
    },
    fromJSONObject = function(CreateSpaceJsonObject) {
      CreateSpaceObject <- CreateSpaceJsonObject #jsonlite::fromJSON(CreateSpaceJson, simplifyVector = FALSE)
      if (!is.null(CreateSpaceObject$`name`)) {
        self$`name` <- CreateSpaceObject$`name`
      }
      if (!is.null(CreateSpaceObject$`parent_id`)) {
        self$`parent_id` <- CreateSpaceObject$`parent_id`
      }
    },
    fromJSON = function(CreateSpaceJson) {
      CreateSpaceObject <- jsonlite::fromJSON(CreateSpaceJson, simplifyVector = FALSE)
      self$fromJSONObject(CreateSpaceObject)
    },
    ...
    fromJSONString = function(CreateSpaceJson) {
      CreateSpaceObject <- jsonlite::fromJSON(CreateSpaceJson, simplifyVector = FALSE)
      self$`name` <- CreateSpaceObject$`name`
      self$`parent_id` <- CreateSpaceObject$`parent_id`
    }
