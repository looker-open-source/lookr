...
LookmlModelExploreAlias <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(LookmlModelExploreAliasJsonObject) {
      LookmlModelExploreAliasObject <- LookmlModelExploreAliasJsonObject #jsonlite::fromJSON(LookmlModelExploreAliasJson, simplifyVector = FALSE)
    ...
    fromJSON = function(LookmlModelExploreAliasJson) {
      LookmlModelExploreAliasObject <- jsonlite::fromJSON(LookmlModelExploreAliasJson, simplifyVector = FALSE)
      self$fromJSONObject(LookmlModelExploreAliasObject)
    },
