...
#' @export
ColorStop <- R6::R6Class(
  'ColorStop',
  public = list(
    `color` = NULL,
    `offset` = NULL,
    initialize = function(`color`, `offset`){
      if (!missing(`color`)) {
    ...
    toJSON = function() {
      ColorStopObject <- list()
      if (!is.null(self$`color`)) {
        ColorStopObject[['color']] <- self$`color`
      }
      if (!is.null(self$`offset`)) {
        ColorStopObject[['offset']] <- self$`offset`
      }

      ColorStopObject
    },
    fromJSONObject = function(ColorStopJsonObject) {
      ColorStopObject <- ColorStopJsonObject #jsonlite::fromJSON(ColorStopJson, simplifyVector = FALSE)
      if (!is.null(ColorStopObject$`color`)) {
        self$`color` <- ColorStopObject$`color`
      }
      if (!is.null(ColorStopObject$`offset`)) {
        self$`offset` <- ColorStopObject$`offset`
      }
    },
    fromJSON = function(ColorStopJson) {
      ColorStopObject <- jsonlite::fromJSON(ColorStopJson, simplifyVector = FALSE)
      self$fromJSONObject(ColorStopObject)
    },
