...
IntegrationApi <- R6::R6Class(
  ...
  public = list(
    ...
    fetch_integration_form = function(integration_id, body, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    update_integration = function(body, integration_id, fields, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    update_integration_hub = function(body, integration_hub_id, fields, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
