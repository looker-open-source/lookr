...
ProjectValidationCache <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(ProjectValidationCacheJsonObject) {
      ProjectValidationCacheObject <- ProjectValidationCacheJsonObject #jsonlite::fromJSON(ProjectValidationCacheJson, simplifyVector = FALSE)
    ...
    fromJSON = function(ProjectValidationCacheJson) {
      ProjectValidationCacheObject <- jsonlite::fromJSON(ProjectValidationCacheJson, simplifyVector = FALSE)
      self$fromJSONObject(ProjectValidationCacheObject)
    },
