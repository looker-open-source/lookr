...
LDAPConfig <- R6::R6Class(
  ...
  public = list(
	...
	if(is.null(self$`auth_password`)) 'NULL' else self$`auth_password`,
	if(is.null(self$`auth_requires_role`)) 'NULL' else self$`auth_requires_role`,
	if(is.null(self$`auth_username`)) 'NULL' else self$`auth_username`,
	if(is.null(self$`connection_host`)) 'NULL' else self$`connection_host`,
	if(is.null(self$`connection_port`)) 'NULL' else self$`connection_port`,
	if(is.null(self$`connection_tls`)) 'NULL' else self$`connection_tls`,
	if(is.null(self$`connection_tls_no_verify`)) 'NULL' else self$`connection_tls_no_verify`,
	...
	if(is.null(self$`force_no_page`)) 'NULL' else self$`force_no_page`,
        lapply(self$`groups`, function(x) paste(x$toJSON(), sep=",")),
	if(is.null(self$`groups_base_dn`)) 'NULL' else self$`groups_base_dn`,
	if(is.null(self$`groups_finder_type`)) 'NULL' else self$`groups_finder_type`,
	if(is.null(self$`groups_member_attribute`)) 'NULL' else self$`groups_member_attribute`,
	if(is.null(self$`groups_objectclasses`)) 'NULL' else self$`groups_objectclasses`,
	if(is.null(self$`groups_user_attribute`)) 'NULL' else self$`groups_user_attribute`,
        lapply(self$`groups_with_role_ids`, function(x) paste(x$toJSON(), sep=",")),
	if(is.null(self$`has_auth_password`)) 'NULL' else self$`has_auth_password`,
	if(is.null(self$`merge_new_users_by_email`)) 'NULL' else self$`merge_new_users_by_email`,
	...
	if(is.null(self$`test_ldap_password`)) 'NULL' else self$`test_ldap_password`,
	if(is.null(self$`test_ldap_user`)) 'NULL' else self$`test_ldap_user`,
	...
	if(is.null(self$`user_attribute_map_ldap_id`)) 'NULL' else self$`user_attribute_map_ldap_id`,
	...
	if(is.null(self$`user_bind_base_dn`)) 'NULL' else self$`user_bind_base_dn`,
	if(is.null(self$`user_custom_filter`)) 'NULL' else self$`user_custom_filter`,
	if(is.null(self$`user_id_attribute_names`)) 'NULL' else self$`user_id_attribute_names`,
	if(is.null(self$`user_objectclass`)) 'NULL' else self$`user_objectclass`,
