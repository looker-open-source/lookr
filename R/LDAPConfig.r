...
LDAPConfig <- R6::R6Class(
  ...
  public = list(
    ...
    `url` = NULL,
    `can` = NULL,
    initialize = function(`enabled`, `connection_host`, `connection_port`, `connection_tls`, `auth_username`, `auth_password`, `has_auth_password`, `user_bind_base_dn`, `user_id_attribute_names`, `user_objectclass`, `user_custom_filter`, `user_attribute_map_email`, `user_attribute_map_first_name`, `user_attribute_map_last_name`, `user_attribute_map_ldap_id`, `merge_new_users_by_email`, `alternate_email_login_allowed`, `modified_at`, `modified_by`, `default_new_user_groups`, `default_new_user_roles`, `default_new_user_role_ids`, `default_new_user_group_ids`, `set_roles_from_groups`, `groups`, `groups_with_role_ids`, `auth_requires_role`, `groups_finder_type`, `groups_base_dn`, `groups_member_attribute`, `groups_user_attribute`, `groups_objectclasses`, `force_no_page`, `test_ldap_user`, `test_ldap_password`, `user_attributes`, `user_attributes_with_ids`, `url`, `can`){
      if (!missing(`enabled`)) {
    ...
    fromJSON = function(LDAPConfigJson) {
      LDAPConfigObject <- jsonlite::fromJSON(LDAPConfigJson)
