...
LookmlModelExploreSet <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(LookmlModelExploreSetJsonObject) {
      LookmlModelExploreSetObject <- LookmlModelExploreSetJsonObject #jsonlite::fromJSON(LookmlModelExploreSetJson, simplifyVector = FALSE)
    ...
    fromJSON = function(LookmlModelExploreSetJson) {
      LookmlModelExploreSetObject <- jsonlite::fromJSON(LookmlModelExploreSetJson, simplifyVector = FALSE)
      self$fromJSONObject(LookmlModelExploreSetObject)
    },
