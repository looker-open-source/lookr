...
UpdateCommand <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      UpdateCommandObject <- list()
      if (!is.null(self$`name`)) {
        UpdateCommandObject[['name']] <- self$`name`
      }
      if (!is.null(self$`description`)) {
        UpdateCommandObject[['description']] <- self$`description`
      }

      UpdateCommandObject
    },
    fromJSONObject = function(UpdateCommandJsonObject) {
      UpdateCommandObject <- UpdateCommandJsonObject #jsonlite::fromJSON(UpdateCommandJson, simplifyVector = FALSE)
      if (!is.null(UpdateCommandObject$`name`)) {
        self$`name` <- UpdateCommandObject$`name`
      }
      if (!is.null(UpdateCommandObject$`description`)) {
        self$`description` <- UpdateCommandObject$`description`
      }
    },
    fromJSON = function(UpdateCommandJson) {
      UpdateCommandObject <- jsonlite::fromJSON(UpdateCommandJson, simplifyVector = FALSE)
      self$fromJSONObject(UpdateCommandObject)
    },
