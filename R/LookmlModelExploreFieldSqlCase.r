...
LookmlModelExploreFieldSqlCase <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(LookmlModelExploreFieldSqlCaseJsonObject) {
      LookmlModelExploreFieldSqlCaseObject <- LookmlModelExploreFieldSqlCaseJsonObject #jsonlite::fromJSON(LookmlModelExploreFieldSqlCaseJson, simplifyVector = FALSE)
    ...
    fromJSON = function(LookmlModelExploreFieldSqlCaseJson) {
      LookmlModelExploreFieldSqlCaseObject <- jsonlite::fromJSON(LookmlModelExploreFieldSqlCaseJson, simplifyVector = FALSE)
      self$fromJSONObject(LookmlModelExploreFieldSqlCaseObject)
    },
