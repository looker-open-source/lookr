...
SamlConfig <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONObject = function(SamlConfigJsonObject) {
      SamlConfigObject <- SamlConfigJsonObject #jsonlite::fromJSON(SamlConfigJson, simplifyVector = FALSE)
    ...
    fromJSON = function(SamlConfigJson) {
      SamlConfigObject <- jsonlite::fromJSON(SamlConfigJson, simplifyVector = FALSE)
      self$fromJSONObject(SamlConfigObject)
    },
	...
	if(is.null(self$`idp_audience`)) 'NULL' else self$`idp_audience`,
	if(is.null(self$`allowed_clock_drift`)) 'NULL' else as.character(self$`allowed_clock_drift`),
	...
	if(is.null(self$`modified_by`)) 'NULL' else self$`modified_by`,
	...
	if(is.null(self$`groups_finder_type`)) 'NULL' else self$`groups_finder_type`,
	if(is.null(self$`groups_member_value`)) 'NULL' else self$`groups_member_value`,
	if(is.null(self$`bypass_login_page`)) 'NULL' else self$`bypass_login_page`,
