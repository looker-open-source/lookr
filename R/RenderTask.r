...
RenderTask <- R6::R6Class(
  ...
  public = list(
	...
	if(is.null(self$`finalized_at`)) 'NULL' else self$`finalized_at`,
	...
	if(is.null(self$`query_runtime`)) 'NULL' else as.character(self$`query_runtime`),
	if(is.null(self$`render_runtime`)) 'NULL' else as.character(self$`render_runtime`),
	...
	if(is.null(self$`status_detail`)) 'NULL' else self$`status_detail`,
